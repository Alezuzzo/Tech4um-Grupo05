...
export default function Home({ 
  ...
  return (
    <div className="w-full mx-auto flex flex-col gap-8 mt-15 max-w-6xl p-4 font-sans">
        ...
        <div className="flex flex-col md:flex-row gap-5">
            <div className="flex flex-1 border border-[#0078D4] rounded-xl justify-between items-center bg-white overflow-hidden shadow-sm focus-within:ring-2 focus-within:ring-[#0078D4]">
                <input 
                    className="px-5 py-4 focus:outline-none text-base placeholder-gray-400 w-full" 
                    type="text" 
                    placeholder="Em busca de uma sala? Encontre-a aqui"
                    value={searchTerm}
                    onChange={(e) => onSearchChange(e.target.value)}
                />
                <button className='bg-[#0078D4] text-white font-bold px-6 h-full transition-colors hover:bg-[#0060AA] flex items-center justify-center text-xl'>
                    →
                </button>
            </div>
